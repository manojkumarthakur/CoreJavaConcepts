...
public class LinkeHashSetRemove {
    // main method
...
// returns false
        ...
        lhs.removeIf(str -> str.contains("Website"));
        System.out.println("After removing Website element, the linked hash set is: " + lhs);

//        lhs.clear();
        System.out.println("After removing all the element, the linked hash set is: " + lhs);
    }
}
